        ...
        <div class="im-box" :class="isShow ? 'im-box-show' : ''"
                ...
                <ul class="im-panel-user-list">
                    ...
                    <template v-for="(item) in sortHistoryMsgList">
                        <li @click="handleChat(item)" :key="item.type + item.id">
                            ...
                            <div class="im-panel-badge" v-if="item.unMsgCount > 0">{{ item.unMsgCount > 99 ? '99+' :
                                item.unMsgCount }}
                            </div>
                        </li>
                    </template>
                ...
                <div v-if="newFriendVisible">
                    <ul class="im-panel-user-list">
                        ...
                        <template v-for="item in newFriendList">
                            <li :key="item.id">
                                <div class="im-user-left">
                                    <img :src="item.user && item.user.avatar | getDefaultAvatar" alt=""
                                ...
                                <div class="im-user-button" :style="{color: item.status !== 0 ? '#ccc' : ''}">
                                    ...
                                    <span v-if="item.status === 0" @click="askAck(item, 2)"
                                          style="margin-left: 3px;">拒绝</span>
                                </div>
                            </li>
                        </template>
                    </ul>
                    <div v-if="newFriendList.length !== 0" class="im-new-friend-list-more"
                         @click="getUserFriendAskList">
            ...
            <main class="im-panel-body" v-if="imTabSelectedIndex === 2">
                ...
                <div class="im-group-create">
                    <input type="text" v-show="createGroupVisible" v-model="createGroupName" placeholder="输入群昵称"
                           style="">
                    <span class="im-group-create-button"
                          @click="createGroup">{{ createGroupVisible ? '提交' : '新建'}}</span>
            ...
            <footer class="im-panel-footer">
                ...
                <div class="im-panel-theme-list" v-if="themeVisible">
                    <div class="im-panel-theme-item" v-for="(item, index) in themeList" :key="index"
                         @click="changeTheme(index, true)">
    ...
    export default {
        ...
        methods: {
            ...
            handleChat(item) {
                ...
                console.log(this.historyMsgListSelected)
